  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full  relative rounded-md overflow-hidden">
        <p className="absolute top-2 left-2 z-2 text-xs flex items-center gap-1 bg-gray-900 rounded py-0.5 px-1 md:group-hover/card:left-1/2 md:group-hover/card:-translate-x-1/2  md:group-hover/card:bg-transparent transition-all duration-300 ">
